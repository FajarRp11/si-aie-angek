<footer class="bg-gray-800 text-white">
    <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
                <h3 class="text-lg font-semibold">Nagari Aie Angek</h3>
                <p class="mt-4 text-gray-400">
                    Kecamatan X Koto, Kabupaten Tanah Datar,
                    Sumatera Barat.
                </p>
                <p class="mt-2 text-gray-400">Email: kontak@nagari-aieangek.go.id</p>
                <p class="mt-2 text-gray-400">Telp: (0752) XXX-XXX</p>
            </div>
            <div>
                <h3 class="text-lg font-semibold">Tautan Cepat</h3>
                <ul class="mt-4 space-y-2">
                    <li><a href="#" class="text-gray-400 hover:text-white">Profil Nagari</a></li>
        ...
        <div class="mt-8 border-t border-gray-700 pt-8 text-center text-gray-400">
            <p>&copy; {{ date('Y') }} Pemerintah Nagari Aie Angek. Semua Hak Cipta Dilindungi.</p>
        </div>
    </div>
</footer>
